...
This code creates the TopicClient that you will use to call the other methods.
...
<SdkExampleCodeBlock language={'swift'} snippetId={'API_Publish'} />

## Subscribe to a topic
This is an example of a simple read operation to get an item from a cache.

<SdkExampleCodeBlock language={'swift'} snippetId={'API_Subscribe'} />
