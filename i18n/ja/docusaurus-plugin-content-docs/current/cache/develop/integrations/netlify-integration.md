...
![Netlify Add Site Button](@site/static/img/netlify-add-site.png)

Then choose your Git provider to display a list of your repositories.

![Netlify Git providers](@site/static/img/netlify-git-providers.png)

From the list of repositories available to you, select `client-sdk-javascript`. 

![Netlify repository list](@site/static/img/netlify-repo-list.png)
...
![Netlify build settings](@site/static/img/netlify-build-settings.png)
...
![Netlify site published](@site/static/img/netlify-published-site.png)
...
![Netlify site overview](@site/static/img/netlify-site-overview.png)
