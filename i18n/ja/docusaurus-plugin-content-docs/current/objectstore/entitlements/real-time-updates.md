...
ユーザーがサブスクリプションを購入すると、新しいコンテンツにすぐにアクセスできるようにする必要があります。しかし、[entitlements](/objectstore/entitlements/about)がクライアントサイドのプレイヤーにキャッシュされている場合、それを効率的に無効にするにはどうすればよいでしょうか？
