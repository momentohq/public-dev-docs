...
/**
 * The Momento Media Storage landing page content. This used to be a standalone
 * `src/pages/media-storage.tsx` with its own <Layout>; it is now rendered from the
 * `/media-storage` doc so that the page gets the left sidebar nav. The surrounding Layout is
 * supplied by the docs route.
 */
export default function MediaStorageLandingPage(): ReactNode {
  return (
