...
You'll need a [Momento API key](/platform/authentication/api-keys) to authenticate with Momento.  You can get one from the [Momento Web Console](https://console.gomomento.com/caches).
