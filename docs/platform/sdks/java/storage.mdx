...
If you need to get going quickly with Java and Momento Storage, this page contains the basic API calls you'll need. [Check the Java SDK examples](https://github.com/momentohq/client-sdk-java/tree/main/examples) for complete, working examples including build configuration files.
