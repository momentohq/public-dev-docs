...
For more information on Momento tokens, including `DisposableTokenScope` and permission objects for authorization, see [Auth API Reference](/platform/authentication#generatedisposabletoken).
