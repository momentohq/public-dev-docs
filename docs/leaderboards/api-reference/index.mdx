...
<div class='row'>
    ...
    <div class='col col--4' style={{paddingRight: '20px'}}>
        ...
        Permanently deletes a leaderboard. You will not be able to recover a leaderboard once it has been deleted.

        #### Parameters
        - **leaderboardName** - *string*: The name of the leaderboard to delete.
