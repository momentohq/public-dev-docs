...
When users purchase a subscription, you need to make new content immediately accessible. But if [entitlements](/objectstore/entitlements/about) are cached on client-side players, how do you invalidate it efficiently?
