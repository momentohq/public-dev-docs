...
sidebar_label: About
title: Entitlements
description: Learn about media entitlements and how to use them with Momento Object Store
hide_title: true
keywords:
  - momento
  - media storage
...
# Entitlements in Momento Object Store
...
## Efficiently managing entitlements with Momento Object Store
...
Another way to approach entitlements is by embedding access to content directly in [session tokens](/platform/authentication/tokens). After your entitlements calculation is complete and you have a known list of media a user can access, you can grant explicit access to the content via a short-lived token.

If Momento Object Store is being used as the [media origin](/objectstore/core-concepts/origin), fine-grained access control can be used to restrict access to content upon request.
...
Imagine your content is stored in Momento Object Store with the following structure:
