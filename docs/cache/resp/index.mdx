...
<Tabs>
<TabItem value="python-glide" label="Python - Valkey">
...
<TabItem value="python-redis" label="Python - Redis">
...
<TabItem value="node-glide" label="Node - Valkey">
...
<TabItem value="node-redis" label="Node - Redis">
...
<TabItem value="java-glide" label="Java - Valkey">
...
<TabItem value="java-redis" label="Java - Redis">
