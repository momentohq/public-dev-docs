...
You'll need a [Momento API key](./../../authentication/api-keys.md) to authenticate with Momento.  You can get one from the [Momento Web Console](https://console.gomomento.com/caches).
