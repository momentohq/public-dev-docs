...
:::warning
Do NOT use compare-and-swap (CAS) APIs such as `SetIfPresent` with scalar or non-CAS APIs such as `Set` or `Delete`.
...
:::warning
Do NOT use compare-and-swap (CAS) APIs such as `SetIfEqual` with scalar or non-CAS APIs such as `Set` or `Delete`.
...
:::warning
Do NOT use compare-and-swap (CAS) APIs such as `SetIfNotEqual` with scalar or non-CAS APIs such as `Set` or `Delete`.
...
:::warning
Do NOT use compare-and-set (CAS) APIs such as `SetIfPresentAndNotEqual` with scalar or non-CAS APIs such as `Set` or `Delete`.
...
:::warning
Do NOT use compare-and-set (CAS) APIs such as `SetIfAbsentOrEqual` with scalar or non-CAS APIs such as `Set` or `Delete`.
