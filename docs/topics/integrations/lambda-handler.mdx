...
1.  [Create the Momento webhook](/topics/develop/guides/creating-a-webhook). _Set the Webhook Destination to a dummy value like https://none.com as it will be updated once the CloudFormation is deployed_.
