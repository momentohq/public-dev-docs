...
Use the `GenerateDisposableToken` function call to create a new token. This token has a max life of 25 hours and cannot be renewed.

For permission scope details, see the [token permissions page](/api/authentication/tokens/permissions).
