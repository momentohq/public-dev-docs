...
description: Learn about the permissions available when creating your session tokens to control access to Momento resources.
pagination_next: null
hide_table_of_contents: true
slug: /api/authentication/tokens/permissions
redirect_from:
