...
You'll need a [Momento auth token](/develop/basics/working-with-momento-auth-tokens) to authenticate with Momento.  You can get one from the [Momento Web Console](https://console.gomomento.com/caches).
