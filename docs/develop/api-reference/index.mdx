...
While you could use [Delete Cache](#delete-cache), then [Create Cache](#create-cache), simply flushing a cache keeps all settings for this cache and only deletes the data in the cache.
