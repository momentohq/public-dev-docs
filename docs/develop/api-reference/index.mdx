...
Sets a given Time To Live (TTL) seconds for a key to the provided value.
...
Sets a given Time To Live (TTL) seconds for a key to the provided value only if it would increase the TTL.
...
Sets a given Time To Live (TTL) seconds for a key to the provided value only if it would decrease the TTL.
