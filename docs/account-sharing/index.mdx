...
- **Operator Limit**: You can add up to 10 operators to your account. If you reach this limit, you will need to remove an existing operator before adding a new one, or you can also request a higher limit by contacting Momento at support@momentohq.com.
