...
:::tip
Below are examples of *invocation permissions* for calling a function. They do **not** grant the function access to other Momento resources inside your account. Functions automatically have permission to access all resources in your account.
:::
